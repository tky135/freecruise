...
python tools/train.py --config_file configs/omnire_neus_ts.yaml --output_root tkyout --project kitti360 --run_name baseline dataset=kitti360/2cams data.scene_idx=999 data.start_timestep=0 data.end_timestep=-1
